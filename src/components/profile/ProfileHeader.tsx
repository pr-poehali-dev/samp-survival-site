    ...
    <header className="bg-transparent border-b border-white/10">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={() => onNavigate("/")} className="text-white hover:text-white/80">
          ...
          <Button variant="outline" onClick={onLogout} className="border-white/30 text-white hover:bg-white/10">
